...
public abstract class DefaultDbMapper<O, E extends Enum<E>> extends DefaultMapper<O, E> implements DbMapper<O, E> {
    ...
    @Override
    public O fromResultSet(final ResultSet resultSet, final E[] fields) throws CoiServiceException, SQLException {
    ...
    @Override
    public O fromResultSet(final ResultSet resultSet, final E[] fields, String columnLabelPrefix) throws CoiServiceException, SQLException {
        final O object = this.newInstance();
        for (final E field : fields) {
    ...
    @Override
    public List<O> listFromResultSet(ResultSet resultSet, E[] fields) throws CoiServiceException, SQLException {
    ...
    @Override
    public void setParameters(final PreparedStatement stmt, final O object, final E[] fields) throws SQLException, CoiServiceException {
        setParameters(stmt, 1, object, fields);
    }

    @Override
    public int setParameters(PreparedStatement stmt, int parameterIndex, O object, E[] fields) throws SQLException, CoiServiceException {
        for (E field : fields) {
    ...
    @Override
    public DbMapping<? extends Object, O> get(final E field) throws CoiServiceException {
        if (null == field) {
    ...
    @Override
    public String getAssignments(E[] fields) throws CoiServiceException {
        if (null == fields) {
    ...
    @Override
    public String getColumns(final E[] fields) throws CoiServiceException {
        return getColumns(fields, null);
    }

    @Override
    public String getColumns(E[] fields, String columnLabelPrefix) throws CoiServiceException {
        if (null == fields) {
            throw new IllegalArgumentException("fields");
        }
        StringBuilder stringBuilder = new StringBuilder(10 * fields.length);
     ...
     */
    public String getParameters(E[] fields) throws CoiServiceException {
        int count = 0;
        if (null != fields) {
            for (E field : fields) {
                DbMapping<? extends Object, O> mapping = get(field);
