...
public interface DbMapping<T, O> extends Mapping<T, O> {
     ...
     * @throws OXException
     */
    void set(ResultSet resultSet, O object) throws SQLException, CoiServiceException;
     ...
     * @throws OXException
     */
    void set(ResultSet resultSet, O object, String columnLabel) throws SQLException, CoiServiceException;
