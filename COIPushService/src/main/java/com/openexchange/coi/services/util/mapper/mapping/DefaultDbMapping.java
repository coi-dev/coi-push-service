...
public abstract class DefaultDbMapping<T, O> extends DefaultMapping<T, O> implements DbMapping<T, O> {
    ...
    @Override
    public void set(final ResultSet resultSet, final O object) throws SQLException, CoiServiceException {
        set(resultSet, object, getColumnLabel());
    }

    @Override
    public void set(final ResultSet resultSet, final O object, String columnLabel) throws SQLException, CoiServiceException {
