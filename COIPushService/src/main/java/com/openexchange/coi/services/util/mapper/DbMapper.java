 ...
 * @since v1.0.0
 */
public interface DbMapper<O, E extends Enum<E>> {

    DbMapping<? extends Object, O> get(E field) throws CoiServiceException;
     ...
     * @throws SQLException
     */
    O fromResultSet(ResultSet resultSet, E[] fields) throws CoiServiceException, SQLException;
     ...
     * @throws SQLException
     */
    O fromResultSet(ResultSet resultSet, E[] fields, String columnLabelPrefix) throws CoiServiceException, SQLException;
     ...
     * @throws SQLException
     */
    List<O> listFromResultSet(ResultSet resultSet, E[] fields) throws CoiServiceException, SQLException;
     ...
     * @throws CoiServiceException
     */
    void setParameters(PreparedStatement stmt, O object, E[] fields) throws SQLException, CoiServiceException;
     ...
     */
    int setParameters(PreparedStatement stmt, int parameterIndex, O object, E[] fields) throws SQLException, CoiServiceException;
     ...
     * @throws CoiServiceException
     */
    String getAssignments(E[] fields) throws CoiServiceException;
     ...
     * @throws CoiServiceException
     */
    String getColumns(E[] fields) throws CoiServiceException;
     ...
     * @throws CoiServiceException
     */
    String getColumns(E[] fields, String columnLabelPrefix) throws CoiServiceException;
