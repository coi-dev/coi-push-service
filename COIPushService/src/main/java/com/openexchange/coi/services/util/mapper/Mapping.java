...
public interface Mapping<T, O> extends Comparator<O> {
     ...
     * @throws OXException
     */
    void set(O object, T value) throws CoiServiceException;
     ...
     */
    boolean truncate(O object, int length) throws CoiServiceException;
     ...
     */
    boolean replaceAll(O object, String regex, String replacement) throws CoiServiceException;
     ...
     * @throws OXException
     */
    void copy(O from, O to) throws CoiServiceException;
